...
public class SentenceWordCountTopology {
  ...
  /**
   * A bolt that counts the words of the sentence that it receives
   */
  static class SentenceWordCountBolt extends BaseRichBolt {
  ...
  public static void main(String[] args) throws Exception
  {
    ...
    builder.setBolt("sentence-word-count-bolt", new SentenceWordCountBolt(), 15).fieldsGrouping("sentence-spout", new Fields("sentence"));
    ...
    builder.setBolt("report-bolt", new ReportBolt(), 1).globalGrouping("sentence-word-count-bolt");
